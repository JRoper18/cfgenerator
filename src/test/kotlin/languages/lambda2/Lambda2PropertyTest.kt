...
internal class Lambda2PropertyTest {
    ...
    fun testSubprogramExamplesCaptured() {
        ...
        assertTrue(out1.isLambdaRun)
        val stmtOut1 = out1.subprogramExamples[0][0]
        // The 0th arg takes no inputs and returns 1
        assertEquals(listOf(ExampleRunData(listOf(), 1)), stmtOut1.subprogramExamples[0])
        assertEquals(
            listOf(
    ...
    fun testSubprogramLambdaCaptured() {
        ...
        assertEquals(lambdaExamples1, stmtOut1.subprogramExamples[0])
    }
}